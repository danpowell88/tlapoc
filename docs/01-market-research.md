...
- **Advertising (TGA + AHPRA):** **no S4 advertising**, **no influencer testimonials**, no advertising to under-18s, higher-risk procedures flagged as **adult content** on social; non-specific terms like "wrinkle-reducing injections" banned. The AHPRA *advertising* guideline binds **anyone** who advertises — clinics, **marketing agencies and social-media influencers** — not just the practitioner. → *advertising/marketing is **out of product scope**: it lives in the clinic's own tools (Mailchimp, Meta Business Suite) and compliance is the clinic's responsibility — the platform builds **no advertising linter and no ad-production tooling**. Its only public surface, the booking page, uses generic service names + withheld S4 prices **by configuration**.*
