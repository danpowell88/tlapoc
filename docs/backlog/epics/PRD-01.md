...
| `CREDENTIALS` | [Staff credentials + canInject compliance gate](../stories/PRD-01__CREDENTIALS.md) | Story | P0 | 5 | 3 |
| `REG-WATCH` | [Registration / PII / CPD expiry alerting](../stories/PRD-01__REG-WATCH.md) | Story | P1 | 3 | 3 |
| `ROSTER` | [Rosters & engagement type](../stories/PRD-01__ROSTER.md) | Story | P1 | 3 | 2 |
