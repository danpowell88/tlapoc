...
> **Stage / Milestone:** M5 · Reporting & apps (PRD-08, PRD-09)  ·  **Phase:** 1  ·  **Stories:** 12
...
|---|---|---|---|---|---|
| `CLIENT-JOURNEY` | [Client app: book → intake → consent journey](../stories/PRD-09__CLIENT-JOURNEY.md) | Story | P1 | 3 | 5 |
| `CLIENT-CARE` | [Client app: my care, memberships, rewards & card-on-file](../stories/PRD-09__CLIENT-CARE.md) | Story | P2 | 2 | 3 |
...
| `PROVIDER-ROOMSIDE` | [Provider app: room-side charting, camera & finalise](../stories/PRD-09__PROVIDER-ROOMSIDE.md) | Story | P1 | 3 | 4 |
...
| `CHECKIN-KIOSK` | [Reception self-check-in surface (tablet)](../stories/PRD-09__CHECKIN-KIOSK.md) | Story | P2 | 2 | 5 |
| `BACKOFFICE-TABLET` | [Back-office / bench tablet surface](../stories/PRD-09__BACKOFFICE-TABLET.md) | Story | P2 | 2 | 4 |
| `CLIENT-CONCERN` | [Client 'report a concern' → follow-up / AE bridge](../stories/PRD-09__CLIENT-CONCERN.md) | Story | P1 | 3 | 4 |

_Totals: 12 stories · 42 tasks._
