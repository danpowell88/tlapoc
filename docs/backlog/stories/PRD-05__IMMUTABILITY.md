...
Immutability is what makes the clinical record stand up in an AHPRA or TGA inspection: once a treatment is finalised, the note can never be silently edited. Any later correction is an appended, audited amendment that preserves the original, so the record shows exactly what was charted at the time and what was changed afterwards, by whom and why.
