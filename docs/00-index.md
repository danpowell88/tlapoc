...
|-----|-------|:-----:|-----------------|------|
| [PRD-01](prds/PRD-01-foundations-tenancy.md) | Foundations & tenancy (auth, RBAC, audit, data model) | 0 | TEN, SEC, C10/C19/C21/C22 | 1,2,3,4,5,8,10,16 |
...
| [PRD-04](prds/PRD-04-consult-prescribing-s4.md) | Consult, prescribing & S4 medicines governance — *the moat* | 1 | RX, MED, C1/C2/C7/C8/C11/C13/C15–C17 | 8,11 |
| [PRD-05](prds/PRD-05-clinical-charting.md) | Clinical charting: injection mapping & before/after | 1 | CLIN, C8/C12/C14 | 9,10,15 |
| [PRD-06](prds/PRD-06-payments-memberships-rewards.md) | Payments (in-person POS + autopay), memberships & non-S4 rewards | 1 | PAY, MEMB, C9/C23 | 7,14 |
| [PRD-07](prds/PRD-07-comms-reminders-recall.md) | Comms, reminders & recall | 1 | NOTIF, C9/C23 | 12 |
...
> Status: DRAFT, 2026-06-18. Working title only — no product name chosen.
