...
> **▸ Prototype alignment (rev 2, 2026-06-19).** No material change — facility/infection-control/emergency stay **lightweight record-keeping** in v1. One linkage worth noting: a **complaint** raised from a conversation (inbox, ADR-0019) should surface the **AHPRA** complaint pathway (C24). See [requirements §12](../02-requirements.md#12-prototype-alignment--feasibility-register).
>
