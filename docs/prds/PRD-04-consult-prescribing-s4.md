...
> **▸ Prototype alignment (rev 2, 2026-06-19).** Medicines is now a **multi-product, multi-unit catalogue** (ADR-0021, **REQ-MED-11**): typed products (toxin/filler/skin) each with their own **unit** (units vs syringes), per-product **on-hand / usage-history / par / expiry**, **vial reconciliation**, and a capability-gated **product admin** that sets the **S4 flag** (the single classification driving rewards eligibility & the public booking-page naming policy, ADR-0014). The consult-gated-script + individual-Rx moat (C1/C2) is unchanged. See [requirements §12](../02-requirements.md#12-prototype-alignment--feasibility-register).
>
...
>
> **▸ Regulatory re-review (rev 5, 2026-06-20).** A fresh QLD/national standards re-read (see [requirements §6.1](../02-requirements.md#61-qld--national-regulatory-re-review--gaps--corrections-2026-06-20)) adds **three** things to this moat: (1) a **third prescriber identity — the *designated RN prescriber*** (QLD endorsement from Sept 2025) who may prescribe S2–S4 **in partnership with an authorised prescriber**; the `Prescription.prescriber` model and credential gate (PRD-01) must accept it, verified by AHPRA endorsement + a recorded partnered prescriber. (2) **Exclusive-custody precision on C7/REQ-MED-2** — the Mode-A custodian must be a prescriber who *physically works at the clinic and holds **exclusive** custody*; record a **custodian + exclusive-custody attestation** + the **designated medicine store contact**; a remote prescriber consigning stock is non-compliant. (3) **Watch:** single-product **telehealth** prescribing (REQ-RX-4) is under national review (report due Dec 2025) — treat the remote path as a configurable regulatory risk.
